...
async function searchTotal(req, res, next) {
    ...
    try {
        ...
        const data = await productRepository.searchTotal(arr,category,product_name);
        // const data = await productRepository.searchTotal();
        res.status(200).send(data);
    } catch (error) {
        console.log(
            "Location: controllers/product/guest/searchTotal.controller.js",
            error.message
        );
